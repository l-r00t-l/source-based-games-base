...
//		return g_utils.call_vfunc<void(__thiscall*)(void*, float, float)>(this, 10)(this, x, y);
	}
...
public:
	...
	void set_vector_internal(const float x, const float y, const float z)
	{
		...
		return g_utils.call_vfunc2<o_fn>(this, 11)(this, x, y, z);
	}
...
public:
	...
	{
		g_utils.call_vfunc2<void(__thiscall*)(void*, vec_t*)>(this, 20)(this, pAmbientOnlyColors);
	}

	void set_local_lights(int nLights, light_desc_t* pLights)
	{
		g_utils.call_vfunc2<void(__thiscall*)(void*, int, light_desc_t*)>(this, 22)(this, nLights, pLights);
	}

	void set_color_modulation(float r, float g, float b)
	{
		g_utils.call_vfunc2<void(__thiscall*)(void*, float, float, float)>(this, 27)(this, r, g, b);
	}

	void set_alpha_modulation(float flAlpha)
	{
		g_utils.call_vfunc2<void(__thiscall*)(void*, float)>(this, 28)(this, flAlpha);
	}

	void forced_material_override(i_material* pMaterial, override_type_t nOverrideType = 0, int nOverrides = 0)
	{
		g_utils.call_vfunc2<void(__thiscall*)(void*, i_material*, override_type_t, int)>(this, 33)(this, pMaterial, nOverrideType, nOverrides);
	}
};
...
public:
	i_material* create_material(const char* name, void* key_values) {
		...
		return g_utils.call_vfunc2< o_fn >(this, 83)(this, name, key_values);
	}
	...
	i_material* find_material(const char* name, const char* group = nullptr) {
		...
		return g_utils.call_vfunc2< o_fn >(this, 84)(this, name, group);
	}

	materialhandle_t first_material() {
		using o_fn = materialhandle_t(__thiscall*)(i_material_system*);
		return g_utils.call_vfunc2< o_fn >(this, 86)(this);
	}
