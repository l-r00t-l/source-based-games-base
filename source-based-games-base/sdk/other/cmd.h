...
public:
	...
	short m_mouse_direction_x{}; // 0x44 mouse accum in x from create move | mouse_delta_x
	short m_mouse_direction_y{}; // 0x46 mouse accum in y from create move | mouse_delta_y
	bool m_has_been_predicted{}; // 0x48 Client only, tracks whether we've predicted this command at least once
	char pad[0x18]{};
// 	qangle_t m_head_angle{};
